    ...
    <>
      <div className="bugpage">
        ...
        <section className="bugdescribe">
          <div className="imgContainer"><img src="/images/wasp.jpg" alt="ant eating scraps picture"/></div>
          <div className="section">
            <div className ="bugDescription">
              <h2>Wasps</h2>
              <p>
                At Lindy's Local, our top priority is to keep your unwanted pests
                under control. When you need to get rid of wasps, our highly trained
                ...
                your wasp controls needs will be met and your pests will remain under
                control.
              </p>
            </div>
