        ...
        <section>
          ...
          <div className="section">
            <div className ="bugDescription">
              <h2>Box Elder Bugs</h2>
              <p>
                At Lindy's Local, our top priority is to keep your unwanted pests
                under control. When you need to get rid of Box Elder Bugs, our highly trained
                ...
                your Box Elder Bug controls needs will be met and your pests will remain under
                control.
              </p>
            </div>
