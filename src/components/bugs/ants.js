  ...
  return (
    <>
      <div className="bugpage">
        ...
        <section>
          <div className="imgContainer"><img src="/images/ant.jpg" alt="ant eating scraps picture"/></div>
          <div className="section">
            <div className ="bugDescription">
              <h2>Ants</h2>
              <p>
                At Lindy's Local, our top priority is to keep your unwanted pests
                under control. When you need to get rid of ants, our highly trained
                ...
                your ant controls needs will be met and your pests will remain under
                control.
              </p>
            </div>
